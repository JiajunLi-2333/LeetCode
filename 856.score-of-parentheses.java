...
Brutal: Let us abstract s = A + B + C where A, B, C are all balanced parentheses strings that constitutes string s. we can identify each one of them by # of ( == # of ). And we can recursively calculate A, B, C, add them up and spawn the answer. So this can be solved by Recursion. TC O(n^2);
Bottleneck:
